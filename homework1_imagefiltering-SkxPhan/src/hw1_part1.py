...
def filter_test(img_path):
    ...
    plt.show()
        ...
        resultsDir + os.sep + "large_blur_image.jpg", large_blur_image
    )
    ...
    plt.show()
        ...
        resultsDir + os.sep + "laplacian_image.jpg", laplacian_image
    )
    ...
    plt.show()
        ...
        resultsDir + os.sep + "high_pass_image.jpg", high_pass_image
    )

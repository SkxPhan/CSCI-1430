...
class YourModel(tf.keras.Model):
    ...
    def __init__(self):
        ...
        self.architecture = [
            Conv2D(
                32, (3, 3), kernel_initializer="he_normal", activation="relu"
            ),
            MaxPool2D((2, 2)),
            Dropout(0.25),
            Conv2D(
                64, (3, 3), kernel_initializer="he_normal", activation="relu"
            ),
            MaxPool2D((2, 2)),
            Dropout(0.25),
            Flatten(),
...
class VGGModel(tf.keras.Model):
    def __init__(self):
        ...
        self.vgg16 = [
            # Block 1
            Conv2D(
                64, 3, 1, padding="same", activation="relu", name="block1_conv1"
            ),
            Conv2D(
                64, 3, 1, padding="same", activation="relu", name="block1_conv2"
            ),
        ...
        self.head = [
            ...
            Dense(hp.num_classes, activation="softmax", name="output"),
        ]
